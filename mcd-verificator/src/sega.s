.text
	...
	.ascii	"SEGA MEGA DRIVE "				    /* Console Name (16) 1 or nothing=ROM, 2=ROM+DATAFILE, 3=RAM*/
	.ascii	"(C)SEGA 1993.SEP"				    /* Copyright Information (16) */
	.ascii	"CDX BOOT ROM     09/07-1993     19:00      2.21X"  /* Domestic Name (48) */
	.ascii	"CDX BOOT ROM                                    "  /* Overseas Name (48) */
	.ascii	"BR 000006-2.21"				    /* Serial Number (2, 14) */
...
.global img
img:
.incbin "img.png-pix.bin"

.global pal
pal:
.incbin "img.png-pal.bin"
